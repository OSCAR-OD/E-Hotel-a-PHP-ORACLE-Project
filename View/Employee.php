        ...
        <div class="formbold-form-wrapper">
            ...
            <form action="../Controller/employeeCheck.php" method="POST">
                ...
                <div class="formbold-input-flex">
                    ...
                    <div>
                        <label for="hiredate" class="formbold-form-label"> Hiredate </label>
                        <input type="date" name="hiredate" id="hiredate" class="formbold-form-input" />
                    </div>
                </div>
                ...
                <div class="formbold-input-flex">
                    <div>
                        <label for="mgr" class="formbold-form-label"> Manager Id</label>
